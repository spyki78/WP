...
define ('anc_6310_PLUGIN_CURRENT_VERSION', 1.8);
...
function anc_6310_animated_number_counter()
{
   ...
   add_menu_page('Animated Number Counter', 'Number Counter', $options, 'animated-number-counters', 'anc_6310_home', 'dashicons-id-alt', 100);
   add_submenu_page('animated-number-counters', 'Animated Number Counter', 'All Created Templates', $options, 'animated-number-counters', 'anc_6310_home');
   add_submenu_page('animated-number-counters', 'Counter 01-10', 'Template 01-10', $options, 'anc-6310-counter-01-10', 'anc_6310_counter_01_10');
   add_submenu_page('animated-number-counters', 'Counter 11-20', 'Template 11-20', $options, 'anc-6310-counter-11-20', 'anc_6310_counter_11_20');
   add_submenu_page('animated-number-counters', 'Counter 21-30', 'Template 21-30', $options, 'anc-6310-counter-21-30', 'anc_6310_counter_21_30');
   add_submenu_page('animated-number-counters', 'Add Counter', 'Manage Counter Profiles', $options, 'anc-6310-accordion-add-edit', 'anc_6310_counter_add_edit');
   add_submenu_page('animated-number-counters', 'Import / Export Plugin', 'Import/Export Plugin', 'manage_options', 'anc-6310-counter-import-export', 'anc_6310_import_export');
   add_submenu_page('animated-number-counters', 'License', 'License', 'manage_options', 'anc-6310-counter-license', 'anc_6310_number_counter_6310_lincense');
   add_submenu_page('animated-number-counters', 'How to use', 'How to use', $options, 'anc-6310-counter-use', 'anc_6310_number_counter_6310_how_to_use');
}
