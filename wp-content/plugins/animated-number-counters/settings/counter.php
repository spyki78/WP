...
<div class="anc-6310">
    ...
    if (!empty($_POST['delete']) && isset($_POST['id']) && is_numeric($_POST['id'])) {
        ...
        if (!wp_verify_nonce($nonce, 'anc-6310-nonce-add')) {
            ...
            $myData[] = sanitize_text_field($_POST['numbers']);
            $myData[] = sanitize_text_field($_POST['icons']);
            $myData[] = sanitize_text_field($_POST['readmore_text']);
            $myData[] = sanitize_text_field($_POST['readmore_url']);
            $myData[] = sanitize_text_field($_POST['image']);
            $myData[] = sanitize_text_field($_POST['number_prefix']) . "###|||###" . sanitize_text_field($_POST['number_suffix']);
            $myData[] = sanitize_text_field($_POST['numbers_start']);
            $myData[] = sanitize_text_field($_POST['icon_type']);
            $myData[] = sanitize_text_field($_POST['custom_icon']);
    ...
    ?>
                        ...
                        <div class="anc-6310-modal-body-form">
                            <table border="0" width="100%" cellpadding="10" cellspacing="0">
                                <tr>
                                    ...
                                    <td><input type="text" name="title" id="title" value="<?php echo esc_attr(anc_6310_special_character_remove($counter['title'])) ?>" class="anc-6310-form-input lg" placeholder="Counter Title" /></td>
                                </tr>
                                <tr>
                                    <td><label class="anc-6310-form-label" for="description">Description:</label></td>
                                    <td>
                                        <textarea name="description" id="description" class="anc-6310-form-input lg"><?php echo esc_textarea(anc_6310_special_character_remove($counter['description'])) ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="number_prefix" id="number_prefix" value="<?php echo esc_attr($numbersPosition[0]) ?>" class="anc-6310-form-input lg" placeholder="Number Prefix" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="numbers_start" id="numbers" value="<?php echo esc_attr($counter['numbers_start']) ?>" class="anc-6310-form-input lg" placeholder="0" /></td>
                                </tr>
                                <tr>
                                    <td style="width: 150px;"><label class="anc-6310-form-label" for="numbers">End Number :</label></td>
                                    <td><input type="text" name="numbers" id="numbers" value="<?php echo esc_attr($counter['numbers']) ?>" class="anc-6310-form-input lg" placeholder="100" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="number_suffix" id="number_suffix" value="<?php echo esc_attr($numbersPosition[1]) ?>" class="anc-6310-form-input lg" placeholder="Number Suffix" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="radio" name='icon_type' class="icon_type_edit" value='1' <?php echo esc_attr($counter['icon_type']) == 1 ? ' checked' : '' ?> style='margin-left: 30px' /> Custom Icon<span class="anc-6310-tooltip">(Pro)</span> :
                                    </td>
                                </tr>
                                <tr class="custom-icon-edit">
                                    <td style="width: 150px;"><label class="anc-6310-form-label" for="picture">Custom Icon:</label></td>
                                    <td>
                                        <input type="text" name="custom_icon" id="custom_icon" class="anc-6310-form-input" value="<?php echo esc_attr($counter['custom_icon']) ?>">
                                ...
                                <tr height="40px" class="anc-6310-form-icon font-awesome-icon-edit" id="1">
                                    ...
                                    <td>
                                        <input type="text" name="icons" id="icons" class="anc-6310-form-input lg" value="<?php echo esc_attr($counter['icons']) ?>" readonly="">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="readmore_text" id="readmore" value="<?php echo esc_attr(anc_6310_special_character_remove($counter['readmore_text'])) ?>" class="anc-6310-form-input lg" placeholder="Read More"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="readmore_url" value="<?php echo esc_url($counter['readmore_url']) ?>" id="readmoreurl" class="anc-6310-form-input lg" placeholder="https://www.wpmart.org"></td>
                                </tr>
                                <tr class="anc-6310-form-image">
                                    <td style="width: 150px;"><label class="anc-6310-form-label" for="picture">Picture:</label></td>
                                    <td>
                                        <input type="text" name="image" id="image" value="<?php echo esc_url($counter['image']) ?>" class="anc-6310-form-input">
            ...
            <script>
                jQuery(document).ready(function() {
                    //Custom Icon
                    <?php
                    echo (esc_attr($counter['icon_type']) != 1) ? "jQuery('.custom-icon-edit').hide();" : "jQuery('.font-awesome-icon-edit').hide();";
                    ?>
            ...
            <div id="anc_6310_rearrange_team_modal" class="anc-6310-modal" style="display: none">
                <div class="anc-6310-modal-content anc-6310-modal-sm">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="member_id" value="<?php echo esc_attr($id) ?>" />
                            ...
                            <ul id="anc-6310-sortable">
                                ...
                                if ($selMember['contact_info']) {
                                    ...
                                    foreach ($contacts as $key => $contact) {
                                        ...
                                        echo "<li class='ui-state-default anc-6310-ui-state-default' id='{$contactNumber}'>" . esc_attr($cls) . ": ".esc_attr($temp[1])."</li>";
                                        $contactNumber++;
                                    }
                                }
                                ?>
                                ...
                                if ($selMember['iconids']) {
                                    ...
                                    for ($i = 0; $i < count($iconIds); $i++) {
                                        if ($iconIds[$i]) {
                                            ...
                                            echo "<li class='ui-state-default anc-6310-ui-state-default' id='{$icons['id']}'><b>".esc_attr($icons['name']).": </b> <button class='anc-6310-btn-icon' style='color:" . esc_attr($icons['color']) . "; background-color: " . esc_attr($icons['bgcolor']) . "; margin-right: 5px; margin-bottom: 5px;'><i class='" . esc_attr($icons['class_name']) . "'></i></button></li>";
                                        }
                                    }
                                }
                                ?>
    ...
    <table class="anc-6310-table">
        ...
        foreach ($data as $value) {
            ...
            echo '<tr>';
            echo '<td>' . anc_6310_special_character_remove(esc_attr($value['title'])) . '</td>';
            echo '<td>' . anc_6310_special_character_remove(esc_attr($value['description'])) . '</td>';
            echo "<td>".esc_attr($numbersPosition[0]) . esc_attr($value['numbers_start']) . esc_attr($numbersPosition[1]) ."</td>";
            echo "<td>".esc_attr($numbersPosition[0]) . esc_attr($value['numbers']) . esc_attr($numbersPosition[1]) ."</td>";
            if ($value['icon_type']) {
                echo '<td align="center">' . (($value['icons']) ? "<img src='".esc_attr($value['custom_icon'])."' style='max-width: 30px' />" : '---') . '</td>';
            } else {
                echo '<td align="center">' . (($value['icons']) ? "<i class='".esc_attr($value['icons'])."' style='font-size: 20px'></i>" : '---') . '</td>';
            }

            echo '<td align="center">' . anc_6310_special_character_remove(esc_attr($value['readmore_text'])) . '</td>';
            echo '<td>
                 <form method="post">
