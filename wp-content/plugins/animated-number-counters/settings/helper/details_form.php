  ...
  <div class="row">
    ...
    <div class="anc-6310-tab-6">
      ...
      <tr height="45">
        ...
        <td>
          <input type="hidden" name="anc_6310_fun_counter_profile_details" id="details_activation" value="<?php echo esc_attr($cssData['anc_6310_fun_counter_profile_details']); ?>">
      ...
      <tr height="45">
        ...
        <td>
          <input type="number" min="0" name="details_summary_words" value="<?php echo esc_attr($cssData['details_summary_words']); ?>" class="anc-6310-form-input anc-6310-no-preview" step="1" id="anc_6310_details_summary_words" />
        </td>
      </tr>
      <tr height="45">
        <td width='55%'><b>Font Size</b></td>
        <td>
          <input type="number" min="0" name="details_font_size" value="<?php echo esc_attr($cssData['details_font_size']); ?>" class="anc-6310-form-input" step="1" id="anc_6310_details_font_size" />
        </td>
      </tr>
      <tr height="45">
        <td><b>Line Height</b></td>
        <td>
          <input name="details_line_height" id="anc_6310_details_line_height" type="number" value="<?php echo esc_attr($cssData['details_line_height']); ?>" class="anc-6310-form-input" />
        </td>
      </tr>
      <tr height="45">
        <td><b>Font Color</b></td>
        <td>
          <input type="text" name="details_font_color" id="anc_6310_details_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['details_font_color']); ?>">
        </td>
      </tr>
      <tr height="45">
        <td><b>Font Hover Color</b></td>
        <td>
          <input type="text" name="details_font_hover_color" id="anc_6310_details_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['details_font_hover_color']); ?>">
        </td>
      </tr>
        ...
        <tr height="45">
          ...
          <td>
            <input type="hidden" name="anc_6310_fun_counter_read_more" id="readmore_activation" value="<?php echo esc_attr($cssData['anc_6310_fun_counter_read_more']); ?>">
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input type="text" min="0" name="read_more_text" value="<?php echo esc_attr($cssData['read_more_text']); ?>" class="anc-6310-form-input" step="1" id="anc_6310_read_more_text" />
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td width='55%'><b>Read More Height</b></td>
          <td>
            <input type="number" min="0" name="read_more_height" value="<?php echo esc_attr($cssData['read_more_height']); ?>" class="anc-6310-form-input" step="1" id="anc_6310_read_more_height" />
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td width='55%'><b>Read More Width</b></td>
          <td>
            <input type="number" name="read_more_width" class="anc-6310-form-input" id="anc_6310_read_more_width" value="<?php echo esc_attr($cssData['read_more_width']); ?>">
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td width='55%'><b>Read More Font Size</b></td>
          <td>
            <input type="number" min="0" name="read_more_font_size" value="<?php echo esc_attr($cssData['read_more_font_size']); ?>" class="anc-6310-form-input" step="1" id="anc_6310_read_more_font_size" />
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td><b>Read More Font Color</b></td>
          <td>
            <input type="text" name="read_more_font_color" id="anc_6310_read_more_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['read_more_font_color']); ?>">
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td><b>Read More Font Hover Color</b></td>
          <td>
            <input type="text" name="read_more_font_hover_color" id="anc_6310_read_more_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['read_more_font_hover_color']); ?>">
          </td>
        </tr>
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input type="text" name="read_more_border_color" id="anc_6310_read_more_border_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['read_more_border_color']) ?>">
          </td>
        </tr>
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input type="number" name="read_more_border_radius" id="anc_6310_read_more_border_radius" class="anc-6310-form-input " value="<?php echo esc_attr($cssData['read_more_border_radius']) ?>">
          </td>
        </tr>
      ...
      <table class="table table-responsive anc_6310_admin_table">
        ...
        <tr height="45">
          <td><b>Font Family</b><?php
                                ?></td>
          <td>
            <input name="details_font_family" id="anc_6310_jquery_profile_details_font" type="text" value="<?php echo esc_attr($cssData['details_font_family']) ?>" />
          </td>
        </tr>
        <tr height="45">
          <td><b>Margin Top</b></td>
          <td>
            <input name="details_margin_top" id="anc_6310_details_margin_top" type="number" value="<?php echo esc_attr($cssData['details_margin_top']) ?>" class="anc-6310-form-input" />
          </td>
        </tr>
        <tr height="45">
          <td><b>Margin Bottom</b></td>
          <td>
            <input name="details_margin_bottom" id="anc_6310_details_margin_bottom" type="number" value="<?php echo esc_attr($cssData['details_margin_bottom']) ?>" class="anc-6310-form-input" />
          </td>
        </tr>
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input type="text" name="read_more_backbround_color" id="anc_6310_read_more_backbround_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['read_more_backbround_color']) ?>">
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td><b>Read More Backgrond Hover Color</b></td>
          <td>
            <input type="text" name="read_more_backbround_hover_color" id="anc_6310_read_more_backbround_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['read_more_backbround_hover_color']) ?>">
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input name="read_more_font_family" id="anc_6310_jquery_read_more_font_family" type="text" value="<?php echo esc_attr($cssData['read_more_font_family']) ?>" />
          </td>
        ...
        <tr height="45" class="read_more_act_field">
          ...
          <td>
            <input name="read_more_margin_top" id="anc_6310_read_more_margin_top" type="number" value="<?php echo esc_attr($cssData['read_more_margin_top']) ?>" class="anc-6310-form-input" />
          </td>
        </tr>
        <tr height="45" class="read_more_act_field">
          <td><b>Read More Margin Bottom</b></td>
          <td>
            <input name="read_more_margin_bottom" id="anc_6310_read_more_margin_bottom" type="number" value="<?php echo esc_attr($cssData['read_more_margin_bottom']) ?>" class="anc-6310-form-input" />
          </td>
        </tr>
      </table>
    </div>
