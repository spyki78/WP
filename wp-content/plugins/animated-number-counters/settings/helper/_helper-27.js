jQuery(document).ready(function() {
    ...
    jQuery("#anc_6310_icon_size").on("change", function() {
        var value = jQuery(this).val() + "px";
        jQuery("<style type='text/css'>.anc-6310-counter-27-icon img{ width:" + value + "; height:" + value + "; } </style>").appendTo(".anc-6310-preview");
    });
    ...
    jQuery('#anc_6310_prefix_icon_show_hide').on('click', function() {
        if (jQuery('#anc_6310_prefix_icon_show_hide').prop('checked') == true) {
            ...
            pre_hidden = 2;
            jQuery("<style type='text/css'>.anc-6310-counter-27-count-prefix { display:inline-block;}</style>").appendTo("body");
        } else {
            jQuery('.prefix-act-field').hide();
            pre_hidden = 1;
            jQuery("<style type='text/css'>.anc-6310-counter-27-count-prefix { display:none;}</style>").appendTo("body");
        }
	...
	jQuery('#anc_6310_suffix_icon_show_hide').on('click', function() {
	    if (jQuery('#anc_6310_suffix_icon_show_hide').prop('checked') == true) {
	        ...
	        suf_hidden = 2;
	        jQuery("<style type='text/css'>.anc-6310-counter-27-count-suffix { display:inline-block;}</style>").appendTo("body");
	    } else {
	        jQuery('.suffix-act-field').hide();
	        suf_hidden = 1;
	        jQuery("<style type='text/css'>.anc-6310-counter-27-count-suffix { display:none;}</style>").appendTo("body");
	    }
	    calculateWidth(hidden);
	});
