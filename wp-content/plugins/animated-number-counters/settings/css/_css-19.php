<style>
    ...
    .anc-6310-counter-19 {
        ...
        height: calc(100% - 2 * <?php echo esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0); ?>px);
    }
    ...
    .anc-6310-counter-19:hover .anc-6310-counter-19-icon img {
        opacity: 0;
    ...
    .anc-6310-counter-19-title {
        ...
        padding-bottom: <?php echo esc_attr($cssData['title_margin_bottom']); ?>px;
    ...
    .anc-6310-counter-19-description {
        ...
        color: <?php echo isset($cssData['description_font_color']) && $cssData['description_font_color'] !== '' ? esc_attr($cssData['description_font_color']) : 'rgb(0, 0, 0)'; ?>;
        ...
        margin-top: <?php echo isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? esc_attr($cssData['description_margin_top']) : 10; ?>px;
        margin-bottom: <?php echo isset($cssData['description_margin_bottom']) && $cssData['description_margin_bottom'] !== '' ? esc_attr($cssData['description_margin_bottom']) : 15; ?>px;
    ...
    .anc-6310-counter-19:hover .anc-6310-counter-19-description {
        color: <?php echo isset($cssData['description_font_hover_color']) && $cssData['description_font_hover_color'] !== '' ? esc_attr($cssData['description_font_hover_color']) : 'rgb(0, 0, 0)'; ?>;
    }
    ...
    .anc-6310-counter-19-button a {
        ...
        font-size: <?php echo isset($cssData['button_font_size']) && $cssData['button_font_size'] !== '' ? esc_attr($cssData['button_font_size']) : 14; ?>px;
        text-decoration: none;
        line-height: <?php echo isset($cssData['button_line_height']) && $cssData['button_line_height'] !== '' ? esc_attr($cssData['button_line_height']) : 20; ?>px;
        font-weight: <?php echo isset($cssData['button_font_weight']) && $cssData['button_font_weight'] !== '' ? esc_attr($cssData['button_font_weight']) : 'normal'; ?>;
        text-transform: <?php echo isset($cssData['button_text_transform']) && $cssData['button_text_transform'] !== '' ? esc_attr($cssData['button_text_transform']) : 'capitalize'; ?>;
        font-family: <?php echo isset($cssData['button_font_family']) && $cssData['button_font_family'] !== '' ? str_replace("+", " ", esc_attr($cssData['button_font_family'])) : 'Roboto'; ?>;
    }

    .anc-6310-counter-19-button a:hover {
