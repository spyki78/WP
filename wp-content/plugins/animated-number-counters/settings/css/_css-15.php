<style>
    ...
    .anc-6310-counter-15-icon {
        width: calc(<?php echo esc_attr($cssData['icon_circle_size']?$cssData['icon_circle_size']:0) ?>px - <?php echo esc_attr($cssData['icon_circle_border_width']?$cssData['icon_circle_border_width']:0) * 2 ?>px);
        height: calc(<?php echo esc_attr($cssData['icon_circle_size']?$cssData['icon_circle_size']:0) ?>px - <?php echo esc_attr($cssData['icon_circle_border_width']?$cssData['icon_circle_border_width']:0) * 2 ?>px);
        border-radius: 50%;
        border-style: solid;
        border-width: <?php echo esc_attr($cssData['icon_circle_border_width']) ?>px;
        display: inline-block;
        border-color: <?php echo esc_attr($cssData['icon_circle_color']) ?> rgba(0, 0, 0, 0) <?php echo esc_attr($cssData['icon_circle_color']) ?> <?php echo esc_attr($cssData['icon_circle_color']) ?>;
        position: relative;
    ...
    .anc-6310-counter-15:hover .anc-6310-counter-15-icon {
        border-color: <?php echo esc_attr($cssData['icon_circle_hover_color']) ?> <?php echo esc_attr($cssData['icon_circle_hover_color']) ?> rgba(255, 255, 255, 0) <?php echo esc_attr($cssData['icon_circle_hover_color']) ?>;
    }

    .anc-6310-counter-15-icon i,
    .anc-6310-counter-15-icon img {
        position: absolute;
        top: 50%;
        line-height: calc(<?php echo esc_attr($cssData['icon_circle_size']) ?>px - <?php echo esc_attr($cssData['icon_circle_border_width']?$cssData['icon_circle_border_width']:0) * 2 ?>px);
        left: 50%;
        border-radius: 50%;
    ...
    .anc-6310-counter-15:hover .anc-6310-counter-15-icon img {
    ...
    .anc-6310-counter-15-button {
        ...
        margin-top: <?php echo isset($cssData['button_margin_top']) && $cssData['button_margin_top'] !== '' ? esc_attr($cssData['button_margin_top']) : 10; ?>px;
