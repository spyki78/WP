<style>
    ...
    .anc-6310-counter-28 {
        background: linear-gradient(-27deg, <?php echo esc_attr($cssData['box_border_color_2']) ?> 50%, <?php echo esc_attr($cssData['box_border_color']) ?> 51%);
        text-align: center;
    ...
    .anc-6310-counter-28:hover {
        background: linear-gradient(-27deg, <?php echo esc_attr($cssData['box_border_hover_color']) ?> 50%, <?php echo esc_attr($cssData['box_border_hover_color_2']) ?> 51%);
    }

    .anc-6310-counter-28-icon {
        color: <?php echo esc_attr($cssData['icon_color']) ?>;
        font-size: <?php echo esc_attr($cssData['icon_size']) ?>px;
        background: linear-gradient(-27deg, <?php echo esc_attr($cssData['box_border_color_2']) ?> 49%, <?php echo esc_attr($cssData['box_border_color']) ?> 50%);
    ...
    .anc-6310-counter-28:hover .anc-6310-counter-28-icon i,
    .anc-6310-counter-28:hover .anc-6310-counter-28-icon img {
        color: <?php echo esc_attr($cssData['icon_hover_color']) ?>;
