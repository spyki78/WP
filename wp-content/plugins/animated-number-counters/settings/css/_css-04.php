<style>
    ...
    .anc-6310-counter-04-top-container {
        width: calc(100% - 2 * <?php echo esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0); ?>px - 2 * <?php echo esc_attr($cssData['box_padding']); ?>px);
        ...
        box-shadow: 0 0px <?php echo (esc_attr($cssData['box_shadow_blur']?$cssData['box_shadow_blur']:0) * 2); ?>px <?php echo esc_attr($cssData['box_shadow_width']); ?>px <?php echo esc_attr($cssData['box_shadow_color']); ?>;
        padding: <?php echo esc_attr($cssData['box_padding']); ?>px;
        margin-top: <?php echo esc_attr($cssData['box_margin_top']); ?>px;
        margin-bottom: <?php echo esc_attr($cssData['box_margin_bottom']); ?>px;
        border-style: solid;
        ...
        -o-transition: all 0.3s ease 0s;
        transition: all 0.3s ease 0s;
        height: calc(100% - <?php echo (esc_attr($cssData['box_padding']?$cssData['box_padding']:0) * 2 + esc_attr($cssData['box_margin_bottom']?$cssData['box_margin_bottom']:0) + 2 * esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0) + esc_attr($cssData['icon_background_size']?$cssData['icon_background_size']:0) + 10); ?>px);
    }
    ...
    .anc-6310-counter-04-top-container:after {
        ...
        border-width: 14px;
        border-style: solid;
        border-color: <?php echo esc_attr($cssData['arrow_color']); ?> transparent transparent;
    }

    .anc-6310-counter-04:hover .anc-6310-counter-04-top-container:after {
        border-color: <?php echo esc_attr($cssData['arrow_hover_color']); ?> transparent transparent;
    }
    ...
    .anc-6310-counter-04-featured-item span {
        ...
        -webkit-border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        -o-border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        -moz-border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        -ms-border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        padding: <?php echo esc_attr($cssData['icon_padding']); ?>px;
        display: flex;
        justify-content: center;
        align-items: center;
        margin-bottom: 10px;
    ...
    .anc-6310-counter-04-featured-item span:before {
        content: '';
        position: absolute;
        border: <?php echo esc_attr($cssData['icon_background_color']); ?> solid 6px;
        border-radius: <?php echo esc_attr($cssData['icon_background_radius']); ?>px;
        top: 0;
        right: 0;
        bottom: 0;
    ...
    .anc-6310-counter-04:hover .anc-6310-counter-04-featured-item span:before {
        border: <?php echo esc_attr($cssData['icon_background_hover_color']); ?> solid 6px;
    ...
    .anc-6310-counter-04-featured-item img {
    ...
    .anc-6310-counter-04:hover .anc-6310-counter-04-featured-item img {
    ...
    .anc-6310-counter-04-button a:hover {
