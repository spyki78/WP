<style>
    ...
    .anc-6310-counter-11 {
        ...
        height: calc(100% - 30px - 2 * <?php echo esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0); ?>px);
    }
    ...
    .anc-6310-counter-11:hover .anc-6310-counter-11-icon img {
    ...
    .anc-6310-counter-11-description {
        ...
        font-family: <?php echo isset($cssData['description_font_family']) && $cssData['description_font_family'] !== '' ? str_replace("+", " ", esc_attr($cssData['description_font_family'])) : 'Amaranth'; ?>;
