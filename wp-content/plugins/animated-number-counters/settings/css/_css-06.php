<style>
    ...
    .anc-6310-counter-06 {
        ...
        height: calc(100% - <?php echo esc_attr(($cssData['box_padding'] ? $cssData['box_padding'] : 0) * 2); ?>px - 2 * <?php echo esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0); ?>px);
    }
    ...
    .anc-6310-counter-06:hover {
        ...
        box-shadow: 0 0 <?php echo esc_attr((($cssData['box_shadow_blur']?$cssData['box_shadow_blur']:0) * 2)); ?>px <?php echo esc_attr($cssData['box_shadow_width_hover']); ?>px <?php echo esc_attr($cssData['box_shadow_hover_color']); ?>;
    }
    ...
    .anc-6310-counter-06:after {
        ...
        width: 0;
        height: 3px;
        background-color: <?php echo esc_attr($cssData['bottom_line_hover_color']); ?>;
        -webkit-transition: all 0.3s ease 0s;
        -moz-transition: all 0.3s ease 0s;
        -ms-transition: all 0.3s ease 0s;
        -o-transition: all 0.3s ease 0s;
