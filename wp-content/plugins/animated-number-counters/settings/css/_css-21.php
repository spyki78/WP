<style>
    ...
    .anc-6310-counter-21 {
        ...
        border: <?php echo esc_attr($cssData['box_border_width']); ?>px solid;
    ...
    .anc-6310-counter-21-row {
        background: <?php echo esc_attr($cssData['image_overlay_color']) ?>;
        width: 100%;
        float: left;
        display: flex;
        justify-content: center;
    ...
    .anc-6310-counter-21-wrapper {
        position: relative;
        width: <?php echo esc_attr($cssData['circle_size']) ?>px;
        height: <?php echo esc_attr($cssData['circle_size']) ?>px;
        animation: <?php echo esc_attr($cssData['animation_duration'] * 2) ?>s;
        font-size: 20px;
        color: #fff;
        font-size: 40px;
    ...
    .anc-6310-suf-pre-wrap-counter-21 {
        margin: 0;
        position: absolute;
        top: 50%;
        width: 100%;
    ...
    .anc-6310-counter-21-count-prefix {
        ...
        vertical-align: <?php echo esc_attr(isset($cssData['number_prefix_position']) && $cssData['number_prefix_position'] !== '' ? $cssData['number_prefix_position'] : 0); ?>px;
    ...
    .anc-6310-counter-21-count-suffix {
        ...
        vertical-align: <?php echo esc_attr(isset($cssData['number_suffix_position']) && $cssData['number_suffix_position'] !== '' ? $cssData['number_suffix_position'] : 0); ?>px;
    ...
    .anc-6310-counter-21-description {
        ...
        color: <?php echo esc_attr(isset($cssData['description_font_color']) && $cssData['description_font_color'] !== '' ? $cssData['description_font_color'] : 'rgb(82, 76, 76)'); ?>;
        ...
        margin-top: <?php echo esc_attr(isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? $cssData['description_margin_top'] : 15); ?>px;
    ...
    .anc-6310-counter-21:hover .anc-6310-counter-21-description {
        color: <?php echo esc_attr(isset($cssData['description_font_hover_color']) && $cssData['description_font_hover_color'] !== '' ? $cssData['description_font_hover_color'] : 'rgb(82, 76, 76)'); ?>;
    }
    ...
    @keyframes finalAnimation {
        ...
        100% {
            border-color: <?php echo esc_attr($cssData['circle_color']); ?>;
        }
    }
    ...
    .anc-6310-circle-span-1-counter-21 {
        ...
        border-top-color: <?php echo esc_attr($cssData['circle_color']); ?>;
        border-left-color: <?php echo esc_attr($cssData['circle_color']); ?>;
        border-radius: 50%;
    }
