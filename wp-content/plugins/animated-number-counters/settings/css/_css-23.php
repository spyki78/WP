<style>
    ...
    .anc-6310-counter-23-icon {
        ...
        width: <?php echo esc_attr($cssData['icon_border_width']) ?>px;
        height: <?php echo esc_attr($cssData['icon_border_width']) ?>px;
        line-height: <?php echo esc_attr($cssData['icon_border_width']) ?>px;
        border-radius: 50%;
        border: 3px solid <?php echo esc_attr($cssData['icon_border_color']) ?>;
    ...
    .anc-6310-counter-23-icon img:before {
        content: "";
        border: 2px solid <?php echo esc_attr($cssData['icon_border_color']) ?>;
        border-radius: 50%;
        position: absolute;
        top: 5px;
        left: 5px;
    ...
    .anc-6310-counter-23:hover .anc-6310-counter-23-icon {
        border: 3px solid <?php echo esc_attr($cssData['icon_border_hover_color']) ?>;
