<style>
    ...
    .anc-6310-counter-07 {
        ...
        height: calc(100% - 70px - 2 * <?php echo esc_attr($cssData['box_border_width']?$cssData['box_border_width']:0) ?>px);
    }
    ...
    .anc-6310-counter-07-count-number {
        ...
        padding-left: <?php echo esc_attr($cssData['number_margin_left']) ?>px;
        padding-right: <?php echo esc_attr($cssData['number_margin_right']) ?>px;
    }
    ...
    .anc-6310-counter-07-count-subtitle {
        ...
        padding-left: <?php echo esc_attr($cssData['description_margin_left']) ?>px;
        padding-right: <?php echo esc_attr($cssData['description_margin_right']) ?>px;
        padding-top: <?php echo esc_attr($cssData['description_margin_top']) ?>px;
        padding-bottom: <?php echo esc_attr($cssData['description_margin_bottom']) ?>px;
        word-break: break-word;
    }
