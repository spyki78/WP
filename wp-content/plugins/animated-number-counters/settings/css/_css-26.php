<style>
    ...
    .anc-6310-counter-26-paralax {
        ...
        background: <?php echo esc_attr($cssData['full_background_color']); ?>;
        overflow: hidden;
    }
...
/* 
    ...
    .anc-6310-counter-26:hover .anc-6310-counter-26-icon i,
    .anc-6310-counter-26:hover .anc-6310-counter-26-icon img {
        transform: rotateY(360deg);
    }

    .anc-6310-counter-26-icon i,
    .anc-6310-counter-26-icon img {
        transition: .8s;
