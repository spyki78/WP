<style>
    ...
    .anc-6310-counter-30-icon {
        ...
        line-height: <?php echo esc_attr(($cssData['icon_background_height']?$cssData['icon_background_height']:0) - (($cssData['icon_background_height']?$cssData['icon_background_height']:0) * .2)); ?>px;
        height: <?php echo esc_attr($cssData['icon_background_height']); ?>px;
        width: <?php echo esc_attr($cssData['icon_background_height']); ?>px;
        border-radius: 50%;
        margin: 0 auto;
        overflow: hidden;
        display: flex;
    ...
    .anc-6310-counter-30:hover .anc-6310-counter-30-icon,
    .anc-6310-counter-30:hover .anc-6310-counter-30-icon img {
    ...
    .anc-6310-counter-30-inner-wrap:before {
        content: '';
        border: 2px dashed <?php echo esc_attr($cssData['box_border_color']); ?>;
        border-radius: 15px;
        position: absolute;
        left: 6px;
        right: 6px;
