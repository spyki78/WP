<style>
    ...
    .anc-6310-counter-25-content {
        ...
        position: relative;
        box-sizing: border-box;
        height: calc(100% - <?php echo esc_attr($cssData['icon_background_size']); ?>px);
    }
    ...
    .anc-6310-counter-25-content:before {
        ...
        width: 100%;
        height: 100%;
        background: <?php echo esc_attr($cssData['box_border_color']); ?>;
        position: absolute;
        top: 0;
        left: 0;
        z-index: -1;
    ...
    .anc-6310-counter-25:hover .anc-6310-counter-25-content:before {
        background: <?php echo esc_attr($cssData['box_border_hover_color']); ?>;
    }
    ...
    .anc-6310-counter-25-icon {
        ...
        overflow: hidden;
        transition: .5s;
        border: <?php echo esc_attr($cssData['icon_border_size']); ?>px solid;
        border-color: <?php echo esc_attr($cssData['icon_border_color']); ?>;
        display: flex;
    ...
    .anc-6310-counter-25-icon:hover {
        border-color: <?php echo esc_attr($cssData['icon_border_hover_color']); ?>;
        background: <?php echo esc_attr($cssData['box_background_hover_color']); ?>;
    }
    

    .anc-6310-counter-25:hover .anc-6310-counter-25-icon i,
    .anc-6310-counter-25:hover .anc-6310-counter-25-icon img {
        transform: rotateY(360deg);
    }

    .anc-6310-counter-25-icon i,
    .anc-6310-counter-25-icon img {
        transition: .8s;
