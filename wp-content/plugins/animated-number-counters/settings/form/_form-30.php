          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0.8" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color']) ?>">
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_color" id="anc_6310_box_border_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0.8" data-format="rgb" value="<?php echo esc_attr($cssData['box_border_color']) ?>">
                </td>
              </tr>
            </table>
          </div>
