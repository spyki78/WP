          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color']) ?>">
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="box_shadow_width_hover" value="<?php echo esc_attr($cssData['box_shadow_width_hover']) ?>" class="anc-6310-form-input" id="anc_6310_box_shadow_width_hover" />
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="bottom_line_hover_color" id="anc_6310_bottom_line_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['bottom_line_hover_color']) ?>">
                </td>
              </tr>
              <?php                 
              ...
              <tr height="45">
                ...
                <td>
                  <select name="icon_text_align" class="anc-6310-form-input" id="anc_6310_icon_text_align">
                    ...
                    <option value="left" <?php if (esc_attr($cssData['icon_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (esc_attr($cssData['icon_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
            </table>
