          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_bottom" id="anc_6310_description_margin_bottom" type="number" value="<?php echo isset($cssData['description_margin_bottom']) && esc_attr($cssData['description_margin_bottom']) !== '' ? esc_attr($cssData['description_margin_bottom']) : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
