          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input type="number" min="0" name="button_width" value="<?php echo isset($cssData['button_width']) && esc_attr($cssData['button_width']) !== '' ? esc_attr($cssData['button_width']) : 130; ?>" class="anc-6310-form-input" id="anc_6310_button_width" />
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && esc_attr($cssData['button_margin_bottom']) !== '' ? esc_attr($cssData['button_margin_bottom']) : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
