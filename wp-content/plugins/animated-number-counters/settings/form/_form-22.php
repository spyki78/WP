          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" name="number_background_width" value="<?php echo esc_attr($cssData['number_background_width']) ?>" class="anc-6310-form-input" id="anc_6310_number_background_width" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="number" name="number_background_height" value="<?php echo esc_attr($cssData['number_background_height']) ?>" class="anc-6310-form-input" id="anc_6310_number_background_height" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="number_background_color" id="anc_6310_number_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['number_background_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="number_background_hover_color" id="anc_6310_number_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['number_background_hover_color']) ?>">
                </td>
              </tr>            
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="prefix-act-field">
                ...
                <td>
                  <input type="number" name="number_prefix_position" id="anc_6310_number_prefix_position" class="anc-6310-form-input" value="<?php echo isset($cssData['number_prefix_position']) && esc_attr($cssData['number_prefix_position']) !== '' ? esc_attr($cssData['number_prefix_position']) : 85; ?>">
                </td>
              </tr>
              <tr height="45" class="prefix-act-field">
                <td><b>Margin Left</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
              ...
              <tr height="45" class="suffix-act-field">
                <td><b>Top/Bottom Position</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" name="number_suffix_position" id="anc_6310_number_suffix_position" class="anc-6310-form-input" value="<?php echo isset($cssData['number_suffix_position']) && esc_attr($cssData['number_suffix_position']) !== '' ? esc_attr($cssData['number_suffix_position']) : 85; ?>">
                </td>
              </tr>
              <tr height="45" class="suffix-act-field">
                <td><b>Margin Left</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
