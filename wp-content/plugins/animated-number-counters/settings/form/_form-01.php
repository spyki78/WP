                    ...
                    <div class="anc-6310-tab-6">
                        <table class="table table-responsive anc_6310_admin_table">
                            ...
                            <tr height="45">
                                ...
                                <td>
                                    <input type="text" name="image_overlay_color" id="anc_6310_image_overlay_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['image_overlay_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                                <td width="55%"><b>Image Overlay Hover Color</b></td>
                                <td>
                                    <input type="text" name="image_overlay_hover_color" id="anc_6310_image_overlay_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['image_overlay_hover_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                    ...
                    <div class="anc-6310-tab-6">
                        <table class="table table-responsive anc_6310_admin_table">
                            <tr height="45">
                                ...
                                <td>
                                    <input type="text" name="number_background_color" id="anc_6310_number_background_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['number_background_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                                <td width='55%'><b>Background Hover Color</b></td>
                                <td>
                                    <input type="text" name="number_background_hover_color" id="anc_6310_number_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['number_background_hover_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                                <td><b>Number Box Size</b></td>
                                <td>
                                    <input type="number" min="0" name="number_box_size" value="<?php echo esc_attr($cssData['number_box_size']) ?>" class="anc-6310-form-input" id="anc_6310_number_box_size">
                                </td>
                            </tr>
                            <tr height="45">
                                <td><b>Number Box Radius</b></td>
                                <td>
                                    <input type="number" min="0" name="number_box_radius" value="<?php echo esc_attr($cssData['number_box_radius']) ?>" class="anc-6310-form-input" id="anc_6310_number_box_radius" />
                                </td>
                            </tr>
                            <tr height="45">
                                <td width='55%'>
                    ...
                    <div class="anc-6310-tab-6">
                        <table class="table table-responsive anc_6310_admin_table" width="100%">
                            ...
                            <tr height="45" class="button-act-field">
                                ...
                                <td>
                                    <input name="button_line_height" id="anc_6310_button_line_height" type="number" value="<?php echo isset($cssData['button_line_height']) ? esc_attr($cssData['button_line_height']) : 25; ?>" class="anc-6310-form-input" />
                                </td>
                            </tr>
                            <tr height="45" class="button-act-field">
                                <td>
                                ...
                                <td>
                                    <input type="text" name="button_font_color" id="anc_6310_button_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['button_font_color']) ? esc_attr($cssData['button_font_color']) : 'rgb(255, 255, 255)'; ?>">
                                </td>
                            </tr>
                            <tr height="45" class="button-act-field">
                                <td>
