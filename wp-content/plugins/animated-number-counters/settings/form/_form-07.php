              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <select name="description_font_weight" class="anc-6310-form-input" id="anc_6310_description_font_weight">
                    <option value="100" <?php if (esc_attr($cssData['description_font_weight']) == '100') echo " selected=''" ?>>100</option>
                    <option value="200" <?php if (esc_attr($cssData['description_font_weight']) == '200') echo " selected=''" ?>>200</option>
                    <option value="300" <?php if (esc_attr($cssData['description_font_weight']) == '300') echo " selected=''" ?>>300</option>
                    <option value="400" <?php if (esc_attr($cssData['description_font_weight']) == '400') echo " selected=''" ?>>400</option>
                    <option value="500" <?php if (esc_attr($cssData['description_font_weight']) == '500') echo " selected=''" ?>>500</option>
                    <option value="600" <?php if (esc_attr($cssData['description_font_weight']) == '600') echo " selected=''" ?>>600</option>
                    <option value="700" <?php if (esc_attr($cssData['description_font_weight']) == '700') echo " selected=''" ?>>700</option>
                    <option value="800" <?php if (esc_attr($cssData['description_font_weight']) == '800') echo " selected=''" ?>>800</option>
                    <option value="900" <?php if (esc_attr($cssData['description_font_weight']) == '900') echo " selected=''" ?>>900</option>
                    <option value="normal" <?php if (esc_attr($cssData['description_font_weight']) == 'normal') echo " selected=''" ?>>Normal</option>
                    <option value="bold" <?php if (esc_attr($cssData['description_font_weight']) == 'bold') echo " selected=''" ?>>Bold</option>
                    <option value="lighter" <?php if (esc_attr($cssData['description_font_weight']) == 'lighter') echo " selected=''" ?>>Lighter</option>
                    <option value="initial" <?php if (esc_attr($cssData['description_font_weight']) == 'initial') echo " selected=''" ?>>Initial</option>
                  </select>
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <select name="description_text_transform" class="anc-6310-form-input" id="anc_6310_description_text_transform">
                    <option value="capitalize" <?php if (esc_attr($cssData['description_text_transform']) == 'capitalize') echo " selected=''" ?>>Capitalize</option>
                    <option value="uppercase" <?php if (esc_attr($cssData['description_text_transform']) == 'uppercase') echo " selected=''" ?>>Uppercase</option>
                    <option value="lowercase" <?php if (esc_attr($cssData['description_text_transform']) == 'lowercase') echo " selected=''" ?>>Lowercase</option>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <select name="description_text_align" class="anc-6310-form-input" id="anc_6310_description_text_align">
                    <option value="center" <?php if (esc_attr($cssData['description_text_align']) == 'center') echo " selected=''" ?>>Center</option>
                    <option value="left" <?php if (esc_attr($cssData['description_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (esc_attr($cssData['description_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr height="45" class="description-act-field">
              ...
              <tr height="45" class="description-act-field">
                <td><b>Margin Left</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo esc_attr($cssData['description_margin_left']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Right</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo esc_attr($cssData['description_margin_right']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
