          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && esc_attr($cssData['description_margin_top']) !== '' ? esc_attr($cssData['description_margin_top']) : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_bottom" id="anc_6310_description_margin_bottom" type="number" value="<?php echo isset($cssData['description_margin_bottom']) && esc_attr($cssData['description_margin_bottom']) !== '' ? esc_attr($cssData['description_margin_bottom']) : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_top" id="anc_6310_button_margin_top" type="number" value="<?php echo isset($cssData['button_margin_top']) && esc_attr($cssData['button_margin_top']) !== '' ? esc_attr($cssData['button_margin_top']) : 25; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="button-act-field">
                <td><b>Margin Bottom </b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
