          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_right_color" id="anc_6310_icon_border_right_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['icon_border_right_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_right_hover_color" id="anc_6310_icon_border_right_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['icon_border_right_hover_color']) ?>">
                </td>
              </tr>
            </table>
          </div>
