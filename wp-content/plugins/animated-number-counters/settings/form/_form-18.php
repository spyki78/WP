          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_1" id="anc_6310_box_background_color_1" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_1']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_1" id="anc_6310_box_background_hover_color_1" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_1']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_2" id="anc_6310_box_background_color_2" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_2']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_2" id="anc_6310_box_background_hover_color_2" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_2']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_3" id="anc_6310_box_background_color_3" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_3']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_3" id="anc_6310_box_background_hover_color_3" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_3']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_4" id="anc_6310_box_background_color_4" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_4']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_4" id="anc_6310_box_background_hover_color_4" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_4']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_5" id="anc_6310_box_background_color_5" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_5']) ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_5" id="anc_6310_box_background_hover_color_5" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_5']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color_6" id="anc_6310_box_background_color_6" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_color_6']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_hover_color_6" id="anc_6310_box_background_hover_color_6" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo esc_attr($cssData['box_background_hover_color_6']) ?>">
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_shadow_color" id="anc_6310_box_shadow_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['box_shadow_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_shadow_hover_color" id="anc_6310_box_shadow_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['box_shadow_hover_color']) ?>">
                </td>
              </tr>
              <?php                 
              ...
              <tr height="45">
                ...
                <td>
                  <select name="title_font_weight" class="anc-6310-form-input" id="anc_6310_title_font_weight">
                    <option value="100" <?php if (esc_attr($cssData['title_font_weight']) == '100') echo " selected=''" ?>>100</option>
                    <option value="200" <?php if (esc_attr($cssData['title_font_weight']) == '200') echo " selected=''" ?>>200</option>
                    <option value="300" <?php if (esc_attr($cssData['title_font_weight']) == '300') echo " selected=''" ?>>300</option>
                    <option value="400" <?php if (esc_attr($cssData['title_font_weight']) == '400') echo " selected=''" ?>>400</option>
                    <option value="500" <?php if (esc_attr($cssData['title_font_weight']) == '500') echo " selected=''" ?>>500</option>
                    <option value="600" <?php if (esc_attr($cssData['title_font_weight']) == '600') echo " selected=''" ?>>600</option>
                    <option value="700" <?php if (esc_attr($cssData['title_font_weight']) == '700') echo " selected=''" ?>>700</option>
                    <option value="800" <?php if (esc_attr($cssData['title_font_weight']) == '800') echo " selected=''" ?>>800</option>
                    <option value="900" <?php if (esc_attr($cssData['title_font_weight']) == '900') echo " selected=''" ?>>900</option>
                    <option value="normal" <?php if (esc_attr($cssData['title_font_weight']) == 'normal') echo " selected=''" ?>>Normal</option>
                    <option value="bold" <?php if (esc_attr($cssData['title_font_weight']) == 'bold') echo " selected=''" ?>>Bold</option>
                    <option value="lighter" <?php if (esc_attr($cssData['title_font_weight']) == 'lighter') echo " selected=''" ?>>Lighter</option>
                    <option value="initial" <?php if (esc_attr($cssData['title_font_weight']) == 'initial') echo " selected=''" ?>>Initial</option>
                  </select>
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <select name="title_text_transform" class="anc-6310-form-input" id="anc_6310_title_text_transform">
                    <option value="capitalize" <?php if (esc_attr($cssData['title_text_transform']) == 'capitalize') echo " selected=''" ?>>Capitalize</option>
                    <option value="uppercase" <?php if (esc_attr($cssData['title_text_transform']) == 'uppercase') echo " selected=''" ?>>Uppercase</option>
                    <option value="lowercase" <?php if (esc_attr($cssData['title_text_transform']) == 'lowercase') echo " selected=''" ?>>Lowercase</option>
                    <option value="none" <?php if (esc_attr($cssData['title_text_transform']) == 'none') echo " selected=''" ?>>As Input</option>
              ...
              <tr height="45">
                ...
                <td>
                  <select name="title_text_align" class="anc-6310-form-input" id="anc_6310_title_text_align">
                    <option value="center" <?php if (esc_attr($cssData['title_text_align']) == 'center') echo " selected=''" ?>>Center</option>
                    <option value="left" <?php if (esc_attr($cssData['title_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (esc_attr($cssData['title_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <select name="icon_text_align" class="anc-6310-form-input" id="anc_6310_icon_text_align">
                    <option value="center" <?php if (esc_attr($cssData['icon_text_align']) == 'center') echo " selected=''" ?>>Center</option>
                    <option value="flex-start" <?php if (esc_attr($cssData['icon_text_align']) == 'left' || esc_attr($cssData['icon_text_align']) == 'flex-start') echo " selected=''" ?>>Left</option>
                    <option value="flex-end" <?php if (esc_attr($cssData['icon_text_align']) == 'right' || esc_attr($cssData['icon_text_align']) == 'flex-end') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input name="icon_margin_left" id="anc_6310_icon_margin_left" type="number" value="<?php echo esc_attr($cssData['icon_margin_left']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Right</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="icon_margin_right" id="anc_6310_icon_margin_right" type="number" value="<?php echo esc_attr($cssData['icon_margin_right']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="icon_margin_top" id="anc_6310_icon_margin_top" type="number" value="<?php echo esc_attr($cssData['icon_margin_top']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="number" min="0" name="description_font_size" value="<?php echo isset($cssData['description_font_size']) && esc_attr($cssData['description_font_size']) !== '' ? esc_attr($cssData['description_font_size']) : 15; ?>" class="anc-6310-form-input" step="1" id="anc_6310_description_font_size" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_line_height" id="anc_6310_description_line_height" type="number" value="<?php echo isset($cssData['description_line_height']) && esc_attr($cssData['description_line_height']) !== '' ? esc_attr($cssData['description_line_height']) : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <select name="description_text_transform" class="anc-6310-form-input" id="anc_6310_description_text_transform">
                    ...
                    <option value="none" <?php if (isset($cssData['description_text_transform']) && esc_attr($cssData['description_text_transform']) == 'none') echo " selected=''" ?>>As Input</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_font_family" id="anc_6310_jquery_description_font" type="text" value="<?php echo isset($cssData['description_font_family']) && esc_attr($cssData['description_font_family']) !== '' ? str_replace("+", " ", esc_attr($cssData['description_font_family'])) : 'roboto'; ?>" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo isset($cssData['description_margin_left']) && esc_attr($cssData['description_margin_left']) !== '' ? esc_attr($cssData['description_margin_left']) : 8; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo isset($cssData['description_margin_right']) && esc_attr($cssData['description_margin_right']) !== '' ? esc_attr($cssData['description_margin_right']) : 8; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && esc_attr($cssData['description_margin_top']) !== '' ? esc_attr($cssData['description_margin_top']) : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_bottom" id="anc_6310_description_margin_bottom" type="number" value="<?php echo isset($cssData['description_margin_bottom']) && esc_attr($cssData['description_margin_bottom']) !== '' ? esc_attr($cssData['description_margin_bottom']) : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <select name="number_font_weight" class="anc-6310-form-input" id="anc_6310_number_font_weight">
                    <option value="100" <?php if (esc_attr($cssData['number_font_weight']) == '100') echo " selected=''" ?>>100</option>
                    <option value="200" <?php if (esc_attr($cssData['number_font_weight']) == '200') echo " selected=''" ?>>200</option>
                    <option value="300" <?php if (esc_attr($cssData['number_font_weight']) == '300') echo " selected=''" ?>>300</option>
                    <option value="400" <?php if (esc_attr($cssData['number_font_weight']) == '400') echo " selected=''" ?>>400</option>
                    <option value="500" <?php if (esc_attr($cssData['number_font_weight']) == '500') echo " selected=''" ?>>500</option>
                    <option value="600" <?php if (esc_attr($cssData['number_font_weight']) == '600') echo " selected=''" ?>>600</option>
                    <option value="700" <?php if (esc_attr($cssData['number_font_weight']) == '700') echo " selected=''" ?>>700</option>
                    <option value="800" <?php if (esc_attr($cssData['number_font_weight']) == '800') echo " selected=''" ?>>800</option>
                    <option value="900" <?php if (esc_attr($cssData['number_font_weight']) == '900') echo " selected=''" ?>>900</option>
                    <option value="normal" <?php if (esc_attr($cssData['number_font_weight']) == 'normal') echo " selected=''" ?>>Normal</option>
                    <option value="bold" <?php if (esc_attr($cssData['number_font_weight']) == 'bold') echo " selected=''" ?>>Bold</option>
                    <option value="lighter" <?php if (esc_attr($cssData['number_font_weight']) == 'lighter') echo " selected=''" ?>>Lighter</option>
                    <option value="initial" <?php if (esc_attr($cssData['number_font_weight']) == 'initial') echo " selected=''" ?>>Initial</option>
                  </select>
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                <td><b>Margin Left</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="number_margin_left" id="anc_6310_number_margin_left" type="number" value="<?php echo esc_attr($cssData['number_margin_left']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Right</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="number_margin_right" id="anc_6310_number_margin_right" type="number" value="<?php echo esc_attr($cssData['number_margin_right']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && esc_attr($cssData['button_margin_bottom']) !== '' ? esc_attr($cssData['button_margin_bottom']) : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
