  ...
  <form method="post">
    ...
    <div class="anc-6310-tab-content">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_color']) && esc_attr($cssData['description_font_color']) !== '' ? esc_attr($cssData['description_font_color']) : 'rgb(89, 82, 82)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_hover_color']) && esc_attr($cssData['description_font_hover_color']) !== '' ? esc_attr($cssData['description_font_hover_color']) : 'rgb(89, 82, 82)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && esc_attr($cssData['description_margin_top']) !== '' ? esc_attr($cssData['description_margin_top']) : 25; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && esc_attr($cssData['button_margin_bottom']) !== '' ? esc_attr($cssData['button_margin_bottom']) : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
      ...
      <div id="tab-7">
        ...
        <div class="css-area">
          <textarea class="codemirror-textarea" name="custom_css" rows="8" cols="70"><?php echo esc_html(anc_6310_special_character_remove($cssData['custom_css'])) ?></textarea>
        </div>
      </div>
