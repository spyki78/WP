      ...
      <div id="tab-3">
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td width='55%'><b>Icon Background Width</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="icon_background_width" id="anc_6310_icon_background_width" type="number" value="<?php echo esc_attr($cssData['icon_background_width']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input name="icon_background_height" id="anc_6310_icon_background_height" type="number" value="<?php echo esc_attr($cssData['icon_background_height']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>             
            </table>
          </div>
