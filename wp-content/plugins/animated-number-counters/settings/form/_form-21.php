          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="circle_size" value="<?php echo esc_attr($cssData['circle_size']) ?>" class="anc-6310-form-input" id="anc_6310_circle_size" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="circle_color" id="anc_6310_circle_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['circle_color']) ?>">
                </td>
              </tr>
              <?php                 
