                    ...
                    <div class="anc-6310-tab-6">
                        <table width="100%">
                            ...
                            <tr height="45">
                                ...
                                <td>
                                    <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".35" value="<?php echo esc_attr($cssData['box_background_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                    ...
                    <div class="anc-6310-tab-6">
                        <table class="table table-responsive anc_6310_admin_table">
                            ...
                            <tr height="45" class="description-act-field">
                                ...
                                <td>
                                    <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo isset($cssData['description_margin_left']) && esc_attr($cssData['description_margin_left']) !== '' ? esc_attr($cssData['description_margin_left']) : 2; ?>" class="anc-6310-form-input" />
                                </td>
                            </tr>
                            <tr height="45" class="description-act-field">
                                <td>
                                ...
                                <td>
                                    <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo isset($cssData['description_margin_right']) && esc_attr($cssData['description_margin_right']) !== '' ? esc_attr($cssData['description_margin_right']) : 2; ?>" class="anc-6310-form-input" />
                                </td>
                            </tr>
                            <tr height="45" class="description-act-field">
                                <td>
                    ...
                    <div class="anc-6310-tab-6">
                        <table class="table table-responsive anc_6310_admin_table">
                            <tr height="45">
                                ...
                                <td>
                                    <input type="text" name="underline_background_color" id="anc_6310_underline_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['underline_background_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                                <td width='55%'><b>Underline Hover Color</b></td>
                                <td>
                                    <input type="text" name="underline_background_hover_color" id="anc_6310_underline_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['underline_background_hover_color']) ?>">
                                </td>
                            </tr>
                            <tr height="45">
                                <td><b>Underline Height</b></td>
                                <td>
                                    <input type="number" name="underline_height" value="<?php echo esc_attr($cssData['underline_height']) ?>" class="anc-6310-form-input" id="anc_6310_underline_height">
                                </td>
                            </tr>
                            <tr height="45">
                                <td><b>Underline Margin Top</b></td>
                                <td>
                                    <input name="underline_margin_top" id="anc_6310_underline_margin_top" type="number" value="<?php echo esc_attr($cssData['underline_margin_top']) ?>" class="anc-6310-form-input" />
                                </td>
                            </tr>
                            <tr height="45">
                                <td><b>Underline Radius</b></td>
                                <td>
                                    <input type="number" min="0" name="underline_radius" value="<?php echo esc_attr($cssData['underline_radius']) ?>" class="anc-6310-form-input" id="anc_6310_underline_radius" />
                                </td>
                            </tr>
                            <tr height="45">
                                <td width='55%'>
