          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="text" name="image_overlay_color" id="anc_6310_image_overlay_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".75" value="<?php echo esc_attr($cssData['image_overlay_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="image_overlay_hover_color" id="anc_6310_image_overlay_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".75" data-format="rgb" value="<?php echo esc_attr($cssData['image_overlay_hover_color']) ?>">
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="icon_circle_size" value="<?php echo esc_attr($cssData['icon_circle_size']) ?>" class="anc-6310-form-input" id="anc_6310_icon_circle_size" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="icon_circle_border_width" value="<?php echo esc_attr($cssData['icon_circle_border_width']) ?>" class="anc-6310-form-input" id="anc_6310_icon_circle_border_width" />
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_left_circle_color" id="anc_6310_icon_left_circle_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo esc_attr($cssData['icon_left_circle_color']) ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_left_circle_hover_color" id="anc_6310_icon_left_circle_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo esc_attr($cssData['icon_left_circle_hover_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_right_circle_color" id="anc_6310_icon_right_circle_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo esc_attr($cssData['icon_right_circle_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_right_circle_hover_color" id="anc_6310_icon_right_circle_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo esc_attr($cssData['icon_right_circle_hover_color']) ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_color']) && esc_attr($cssData['description_font_color']) !== '' ? esc_attr($cssData['description_font_color']) : 'rgb(82, 76, 76)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_hover_color']) && esc_attr($cssData['description_font_hover_color']) !== '' ? esc_attr($cssData['description_font_hover_color']) : 'rgb(82, 76, 76)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && esc_attr($cssData['description_margin_top']) !== '' ? esc_attr($cssData['description_margin_top']) : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
              ...
              <tr height="45">
                ...
                <td>
                  <select name="number_text_align" class="anc-6310-form-input" id="anc_6310_number_text_align">
                    <option value="center" <?php if (esc_attr($cssData['number_text_align']) == 'center') echo " selected=''" ?>>Center</option>
                    <option value="left" <?php if (esc_attr($cssData['number_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (esc_attr($cssData['number_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr height="45">
