          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".55" value="<?php echo esc_attr($cssData['box_background_color']) ?>">
                </td>
              </tr>
              <tr height="45">
      ...
      <div id="tab-3">
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input name="icon_border_size" id="anc_6310_icon_border_size" type="number" value="<?php echo esc_attr($cssData['icon_border_size']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
            <tr height="45">
                <td width='55%'><b>Icon background size</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="icon_background_size" id="anc_6310_icon_background_size" type="number" value="<?php echo esc_attr($cssData['icon_background_size']) ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input type="text" name="button_background_hover_color" id="anc_6310_button_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo isset($cssData['button_background_hover_color']) && esc_attr($cssData['button_background_hover_color']) !== '' ? $cssData['button_background_hover_color'] : 'rgba(7, 144, 204, 0.8)'; ?>">
                </td>
              </tr>
              <tr height="45" class="button-act-field">
                <td width='55%'><b>Font Size </b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
