              ...
              <tr height="45">
                ...
                <td>
                  <select name="icon_text_align" class="anc-6310-form-input" id="anc_6310_icon_text_align">
                    ...
                    <option value="left" <?php if (esc_attr($cssData['icon_text_align']) == 'left' || esc_attr($cssData['icon_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (esc_attr($cssData['icon_text_align']) == 'right' || esc_attr($cssData['icon_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_color']) && esc_attr($cssData['description_font_color']) !== '' ? esc_attr($cssData['description_font_color']) : 'rgb(0, 0, 0)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_hover_color']) && esc_attr($cssData['description_font_hover_color']) !== '' ? esc_attr($cssData['description_font_hover_color']) : 'rgb(0, 0, 0)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_top" id="anc_6310_button_margin_top" type="number" value="<?php echo isset($cssData['button_margin_top']) && esc_attr($cssData['button_margin_top']) !== '' ? esc_attr($cssData['button_margin_top']) : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="button-act-field">
                <td><b>Margin Bottom </b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
