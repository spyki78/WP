          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" name="icon_line_height" value="<?php echo esc_attr($cssData['icon_line_height']) ?>" class="anc-6310-form-input" id="anc_6310_icon_line_height" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo isset($cssData['description_margin_left']) && esc_attr($cssData['description_margin_left']) !== '' ? esc_attr($cssData['description_margin_left']) : 3; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo isset($cssData['description_margin_right']) && esc_attr($cssData['description_margin_right']) !== '' ? esc_attr($cssData['description_margin_right']) : 3; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && esc_attr($cssData['button_margin_bottom']) !== '' ? esc_attr($cssData['button_margin_bottom']) : 30; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
