          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="box_radius" value="<?php echo isset($cssData['box_radius']) && esc_attr($cssData['box_radius']) !== '' ? esc_attr($cssData['box_radius']) : 8; ?>" class="anc-6310-form-input" id="anc_6310_box_radius" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="title_font_size" value="<?php echo isset($cssData['title_font_size']) && esc_attr($cssData['title_font_size']) !== '' ? esc_attr($cssData['title_font_size']) : 25; ?>" class="anc-6310-form-input" step="1" id="anc_6310_title_font_size" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input name="title_line_height" id="anc_6310_heading_line_height" type="number" value="<?php echo isset($cssData['title_line_height']) && esc_attr($cssData['title_line_height']) !== '' ? esc_attr($cssData['title_line_height']) : 25; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input name="title_margin_top" id="anc_6310_title_margin_top" type="number" value="<?php echo isset($cssData['title_margin_top']) && esc_attr($cssData['title_margin_top']) !== '' ? esc_attr($cssData['title_margin_top']) : 5; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input name="title_margin_bottom" id="anc_6310_title_margin_bottom" type="number" value="<?php echo isset($cssData['title_margin_bottom']) && esc_attr($cssData['title_margin_bottom']) !== '' ? esc_attr($cssData['title_margin_bottom']) : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" name="icon_size" value="<?php echo isset($cssData['icon_size']) && esc_attr($cssData['icon_size']) !== '' ? esc_attr($cssData['icon_size']) : 40; ?>" class="anc-6310-form-input" id="anc_6310_icon_size">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_color" id="anc_6310_icon_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo isset($cssData['icon_color']) && esc_attr($cssData['icon_color']) !== '' ? esc_attr($cssData['icon_color']) : 'rgb(255,169,35, 1)'; ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_hover_color" id="anc_6310_icon_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo isset($cssData['icon_hover_color']) && esc_attr($cssData['icon_hover_color']) !== '' ? esc_attr($cssData['icon_hover_color']) : 'rgb(255,169,35, 1)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Text Align</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <select name="icon_text_align" class="anc-6310-form-input" id="anc_6310_icon_text_align">
                    <option value="center" <?php if (isset($cssData['icon_text_align']) && esc_attr($cssData['icon_text_align']) == 'center') echo " selected=''" ?>>Center</option>
                    <option value="left" <?php if (isset($cssData['icon_text_align']) && esc_attr($cssData['icon_text_align']) == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if (isset($cssData['icon_text_align']) && esc_attr($cssData['icon_text_align']) == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
              ...
              <tr height="45">
                <td><b>Margin Right</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="icon_margin_right" id="anc_6310_icon_margin_right" type="number" value="<?php echo isset($cssData['icon_margin_right']) && esc_attr($cssData['icon_margin_right']) !== '' ? esc_attr($cssData['icon_margin_right']) : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="number_font_size" value="<?php echo isset($cssData['number_font_size']) && esc_attr($cssData['number_font_size']) !== '' ? esc_attr($cssData['number_font_size']) : 32; ?>" class="anc-6310-form-input" id="anc_6310_number_font_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Line Height</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="number_line_height" value="<?php echo isset($cssData['number_line_height']) && esc_attr($cssData['number_line_height']) !== '' ? esc_attr($cssData['number_line_height']) : 32; ?>" class="anc-6310-form-input" id="anc_6310_number_line_height" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Color</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
              ...
              <tr height="45">
                <td><b>Margin Top</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="number_margin_top" id="anc_6310_number_margin_top" type="number" value="<?php echo isset($cssData['number_margin_top']) && esc_attr($cssData['number_margin_top']) !== '' ? esc_attr($cssData['number_margin_top']) : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b> <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
