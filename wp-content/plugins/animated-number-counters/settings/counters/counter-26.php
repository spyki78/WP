<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-26.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-26">
                                            <div class="anc-6310-counter-26-content">
                                                ...
                                                <div class="anc-6310-counter-26-number-content">
                                                    <div class="anc-6310-counter-26-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                                ...
                                                <div class="anc-6310-counter-26-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                                <?php
