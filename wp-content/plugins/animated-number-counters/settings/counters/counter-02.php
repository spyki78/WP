<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-02.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-02">
                                            ...
                                            <div class="anc-6310-counter-02-count-content">
                                                <div class="anc-6310-counter-02-count-content-inner">
                                                    <div class="anc-6310-counter-02-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                                    <div class="anc-6310-counter-02-count-number anc-6310-counter-number" 
                                            ...
                                            <div class="anc-6310-counter-02-count-title"><?php echo esc_attr(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                            <div class="anc-6310-counter-02-description"><?php echo esc_attr(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                            <?php
