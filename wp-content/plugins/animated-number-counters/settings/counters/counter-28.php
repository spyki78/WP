<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-28.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-28">
                                            <div class="anc-6310-counter-28-top-wrap">
                                                ...
                                                <div class="anc-6310-counter-28-inner-wrap">
                                                    ...
                                                    <div class="anc-6310-counter-28-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
