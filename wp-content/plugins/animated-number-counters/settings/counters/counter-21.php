<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-21.js', __FILE__), array('jquery'));
        ?>
                                                    ...
                                                    <div class="anc-6310-counter-21-number-content">
                                                        <div class="anc-6310-counter-21-wrapper">
                                                            <div class="final-animation">
                                                                <div class="anc-6310-suf-pre-wrap-counter-21">
                                                                    <div class="anc-6310-counter-21-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                                                        <div class="anc-6310-counter-21-number anc-6310-counter-number" 
                                                            ...
                                                            <div class="anc-6310-circle-section-counter-21">
                                                                ...
                                                                <div class="anc-6310-circle-span-1-counter-21" id="fixed"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
