<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-05.js', __FILE__), array('jquery'));
        ?>
                                                ...
                                                <div class="anc-6310-counter-05-count-content anc-6310-counter-05-count-content-hidden">
                                                    ...
                                                    <div class="anc-6310-counter-05-count-content-inner">
                                                        <div class="anc-6310-counter-05-count-number">
                                                            <?php echo esc_html($allCounter['numbers']); ?>
                                                        </div>
                                                    </div>
                                                    <?php anc_6310_counter_suffix($numbersPosition[1], $templateId); ?>
                                                </div>
                                                <div class="anc-6310-counter-05-count-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                                <div class="anc-6310-counter-05-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                                <?php
