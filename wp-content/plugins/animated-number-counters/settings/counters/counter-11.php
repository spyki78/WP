<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-11.js', __FILE__), array('jquery'));
        ?>
                                    ...
                                    ?>
                                        <div class="anc-6310-col-<?php echo esc_attr($cssData['item_per_row']); ?>">
                                            <div class="anc-6310-counter-11">
                                                <div class="anc-6310-counter-11-icon-wrapper">
                                                    <div class="anc-6310-counter-11-icon"><?php anc_6310_icon_image_load($allCounter); ?></div>
                                                </div>
                                                <div class="anc-6310-counter-11-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                                <div class="anc-6310-counter-11-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                                <div class="anc-6310-counter-11-number anc-6310-counter-number" id="anc-6310-<?php echo esc_attr("{$styleId}-{$allCounter['id']}"); ?>" data-anc-6310-start="<?php echo esc_attr($allCounter['numbers_start']); ?>" data-anc-6310-end="<?php echo esc_attr($allCounter['numbers']); ?>" data-anc-6310-decimal="<?php echo esc_attr(anc_6310_number_format($allCounter['numbers'])); ?>" data-anc-6310-duration="<?php echo esc_attr(isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5); ?>"    data-anc-6310-thousands-separator="<?php echo esc_attr(isset($cssData['thousands_separator']) ? anc_6310_special_character_remove($cssData['thousands_separator']) : ''); ?>">
                                                ...
                                                <div class="anc-6310-counter-11-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                                <?php
