<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-15.js', __FILE__), array('jquery'));
        ?>
                                ...
                                ?>
                                    <div class="anc-6310-col-<?php echo esc_attr($cssData['item_per_row']); ?>">
                                        <div class="anc-6310-counter-15">
                                            ...
                                            <div class="anc-6310-counter-15-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                            <?php
