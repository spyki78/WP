<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-06.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-06">
                                            <div class="anc-6310-counter-06-icon">
                                                ...
                                                <div class="anc-6310-counter-06-number-content">
                                                    <div class="anc-6310-counter-06-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                            ...
                                            <div class="anc-6310-counter-06-count-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                            <div class="anc-6310-counter-06-count-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                            <?php
