<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-07.js', __FILE__), array('jquery'));
        ?>
                    ...
                    <div class="anc-6310-counter-07-paralax">
                        <div class="anc-6310-counter-07-common-overlay">
                            ...
                            <div class="anc-6310-counter-07-row">
                                ...
                                ?>
                                    <div class="anc-6310-col-<?php echo esc_attr($cssData['item_per_row']); ?> no-ml-mr-mb-0 custom-full-width-<?php echo esc_attr($cssData['item_per_row']); ?>">
                                        <div class="anc-6310-counter-07">
                                            <div class="anc-6310-counter-07-count-content">
                                                <div class="anc-6310-counter-07-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                            ...
                                            <div class="anc-6310-counter-07-count-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                            <div class="anc-6310-counter-07-count-subtitle"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                            <?php
