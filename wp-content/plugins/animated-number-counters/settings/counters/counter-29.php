<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-29.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-29">
                                            <div class="anc-6310-counter-29-top-wrap">
                                                <div class="anc-6310-counter-29-inner-wrap">
                                                    ...
                                                    <div class="anc-6310-counter-29-title"><?php echo esc_html(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                                    <div class="anc-6310-counter-29-description"><?php echo esc_html(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                                    <?php
