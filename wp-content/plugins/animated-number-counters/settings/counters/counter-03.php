<div class="anc-6310-6310">
    <div class="anc-6310-sm">
        ...
        wp_enqueue_script('anc-6310-form-helper', plugins_url('../helper/_helper-03.js', __FILE__), array('jquery'));
        ?>
                                        ...
                                        <div class="anc-6310-counter-03">
                                            ...
                                            <div class="anc-6310-counter-03-count-content-inner">
                                                <div class="anc-6310-counter-03-count-content">
                                                    <div class="anc-6310-counter-03-count-prefix"><?php echo esc_html($numbersPosition[0]); ?></div>
                                                    <div class="anc-6310-counter-03-count-number anc-6310-counter-number" 
                                                        ...
                                                        data-anc-6310-decimal="<?php echo esc_attr(anc_6310_number_format($allCounter['numbers'])); ?>" data-anc-6310-duration="<?php echo esc_attr(isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5); ?>" 
                                                ...
                                                <div class="anc-6310-counter-03-count-title"><?php echo esc_attr(anc_6310_special_character_remove($allCounter['title'])); ?></div>
                                                <div class="anc-6310-counter-03-description"><?php echo esc_attr(anc_6310_special_character_remove($allCounter['description'])); ?></div>
                                                <?php
