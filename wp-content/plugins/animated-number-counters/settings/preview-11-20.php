...
if (!empty($_POST['submit']) && $_POST['submit'] == 'Save' && $_POST['style'] != '') {
  ...
  if (!wp_verify_nonce($nonce, 'anc-6310-nonce-field')) {
    ...
    if ($redirect_id == 0) {
      ...
      $url = admin_url("admin.php?page=anc-6310-counter-11-20&styleid=$redirect_id");
    }
