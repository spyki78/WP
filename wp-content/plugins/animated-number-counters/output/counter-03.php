                ...
                ?>
                    <div class="anc-6310-col-<?php echo esc_attr($cssData['item_per_row']); ?>">
                        <div class="anc-6310-counter-<?php echo esc_attr($ids); ?>">
                            <div class="anc-6310-counter-<?php echo esc_attr($ids); ?>-featured-item">
                                <span><i class="<?php echo esc_attr($allCounter['icons']); ?>"></i></span>
                            </div>
